...
1. Copie os arquivos do plugin para a pasta `/wp-content/plugins/gateway-kamoney-v2`, ou instale-o diretamente na tela de plugins do WordPress;
...
2. Gere suas credenciais (chaves secreta e pública) no menu API;
...
4. Cole suas chaves geradas nos respectivos campos "Chave pública Kamoney" e "Chave secreta Kamoney";
5. Salve as alterações na parte inferior da página;

Caso deseje realizar simulações em testnet (rede de testes Bitcoin ou Litecoin), possuímos um ambiente Sandbox.

Envie um e-mail para suporte@kamoney.com.br e solicite suas credenciais Sandbox.
